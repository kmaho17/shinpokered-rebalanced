...
BlackbeltData:
; Fighting Dojo
	db $FF,40,PRIMEAPE,40,POLYWRATH,40,HITMONLEE,40,HITMONCHAN,0	;joenote - dojo master raised 1 level to get some extra moves
...
; Silph Co. 11F
	db $FF,40,NIDORINO,40,KANGASKHAN,42,PERSIAN,40,RHYHORN,45,NIDOQUEEN,0
; Viridian Gym
...
LtSurgeData:
	db $FF,21,MAGNEMITE,21,VOLTORB,30,RAICHU,0
ErikaData:
	db $FF,33,TANGELA,34,VICTREEBEL,31,BUTTERFREE,31,IVYSAUR,40,VILEPLUME,0
KogaData:
	db $FF,40,WEEZING,40,MUK,40,ARBOK,42,GOLBAT,45,VENOMOTH,0
BlaineData:
	db $FF,48,RAPIDASH,50,CHARIZARD,48,NINETALES,50,ARCANINE,55,MAGMAR,0
SabrinaData:
	db $FF,45,GENGAR,40,KADABRA,40,MR_MIME,48,HYPNO,50,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
